...
def Execute():
    ...
    for ch in range(8):
        #測定開始通知
        print(datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S") + " ch" + format(ch,"#01d") + ":measurement start")
        ...
        #測定終了通知
        print(datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S") + " ch" + format(ch,"#01d") + ":measurement finish")
